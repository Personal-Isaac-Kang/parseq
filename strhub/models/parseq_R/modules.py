...
class DecoderLayer(nn.Module):
    ...
    def forward(self, query, content, memory, query_mask: Optional[Tensor] = None, content_mask: Optional[Tensor] = None,
                content_key_padding_mask: Optional[Tensor] = None, debug: bool = False):
...
class Refiner(nn.Module):
    ...
    def __init__(self, refiner_layer, num_layers, norm):
        super().__init__()
        self.layers = transformer._get_clones(refiner_layer, num_layers)
        self.num_layers = num_layers
        self.norm = norm
