...
class DecoderLayer(nn.Module):
    ...
    def forward_stream(self, tgt: Tensor, tgt_norm: Tensor, tgt_kv: Tensor, memory: Tensor, tgt_mask: Optional[Tensor],
        ...
        # memory : V
        # tgt_mask : Q-K mask
        # tgt_key_padding_mask : K pad mask
    ...
    def forward(self, query, content, memory, query_mask: Optional[Tensor] = None, content_mask: Optional[Tensor] = None,
        ...
        # content : L
        # memory : V
        # query_mask : Q-K mask of O-L
        # content_mask : Q-K mask of L-L
        # content_key_padding_mask : K pad mask of O-L, L-L
        ...
        # memory : V
        # query_mask : Q-K mask
        # content_key_padding_mask : K pad mask
        if update_content:
